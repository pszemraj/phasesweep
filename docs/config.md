...
Validation supports at most 4,096 candidate parent-outcome expansions per experiment, including combinations rejected as incompatible. A configuration exceeding this temporary complexity ceiling fails before execution and names the affected phase; reduce conditional promotion branching or parent combinations.
